...
<html>
<head>
  <title>Detail Request Barang ATK</title>
    ...
    <div class="container">
		...
		<div class="data-tables datatable-dark">	
            <table id="mauexport" class="table table-bordered" width="100%" cellspacing="0">
                ...
                <?php
                    $no = 0;
                    $sql= mysqli_query($koneksi, "SELECT * FROM tb_request WHERE pic='$nama' AND keterangan='Sudah di Proses Tim GA'") or die(mysqli_error($koneksi));
                    $result = array();
